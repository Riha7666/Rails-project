...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { age: @employer.age, experience: @employer.experience, name: @employer.name, specialization: @employer.specialization, timing: @employer.timing } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { age: @employer.age, experience: @employer.experience, name: @employer.name, specialization: @employer.specialization, timing: @employer.timing } }
